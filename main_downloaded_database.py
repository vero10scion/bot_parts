                                    ...
                                    for event in longpoll.listen():
                                        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                            ...
                                            if msg == 'хорошо, продолжить' and user_states[user_id] == 'on_off_sber':
                                                ...
                                                send_msg(user_id, message, get_keyboard("rethink_sber"),
                                                         state="agreement_sber")

                                                for event in longpoll.listen():
                                                    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                                        msg = event.text.lower()
                                                        user_id = event.user_id
                                                    if msg == 'хорошо, продолжить' and user_states[
                                                        user_id] == 'agreement_sber':
                                                        send_msg(user_id, 'Введите желаемую сумму',
                                                                 get_keyboard('skip'))
                                                        for event in longpoll.listen():
                                                            if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                                                msg = event.text.lower()
                                                                    ...
                                                                    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                                                        ...
                                                                        for event in longpoll.listen():
                                                                            if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                                                                ...
                                                                                cursor.execute(
                                                                                    f"SELECT link FROM comp WHERE (ur_name LIKE '%МФК%') OR (ur_name LIKE '%МКК%')")
                                                                                res = cursor.fetchone()
                                                                                if res != "None":
                                                                                    send_msg(user_id, 'Эта организация подходит требованиям')
                                                                                    send_msg(user_id, res)
                                                                                else:
                                                                                    send_msg(user_id,
                                                                                             'К сожалению, в имеющейся базе данных нет этого типа организации')
                                                                                    send_msg(user_id,
                                    ...
                                    for event in longpoll.listen():
                                        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                            ...
                                            if msg == 'регулярно' and user_states[user_id] == 'once_sber':
                                                ...
                                                send_msg(user_id, message, get_keyboard("yesno"),
                                                         state="selhos_sber")
                                                ...
                                                for event in longpoll.listen():
                                                    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                                        msg = event.text.lower()
                                                        user_id = event.user_id
                                                        if msg == 'да' and user_states[user_id] == 'selhos_sber':
                                                            ...
                                                            print(msg)
                                                            cursor.execute(
                                                            f"SELECT link FROM comp WHERE ur_name LIKE '%СКПК%'")
                                                            res = cursor.fetchone()
                                                            if res == "None":
                                                                send_msg(user_id,
                                                                         'К сожалению, в имеющейся базе данных нет этого типа организации')
                                                                ...
                                                                send_msg(user_id,
                                                                         'Эта организация подходит требованиям')
                                                                send_msg(user_id, res)


                                                        elif msg == 'нет' and user_states[user_id] == 'selhos_sber':
                                                            ...
                                                            cursor.execute(
                                                            f"SELECT link FROM comp WHERE ur_name LIKE '%КПК%'")
                                                            res = cursor.fetchone()
                                                            if res != "None":
                                                                send_msg(user_id,
                                                                         'Эта организация подходит требованиям')
                                                ...
                                                cursor.execute(
                                                    f"SELECT link FROM comp WHERE (ur_name LIKE '%МКК%') OR (ur_name LIKE '%МФК%') OR (ur_name LIKE '%Ломбард%')  ")
                                                res = cursor.fetchone()
                                                if res != "None":
                                                    send_msg(user_id, 'Эта организация подходит требованиям')
                                                    send_msg(user_id, res)
                                                ...
                                                if prev_state == "service_selection_sber":
                                                    ...
                                                    message = "Вы хотели бы обратиться онлайн или офлайн?"
                                                    send_msg(user_id, message, get_keyboard("on_off"),
                                                             state='service_selection_sber')
                        ...
                        for event in longpoll.listen():
                            if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                ...
                                if msg == "мфк" or msg == "мкк":
                                    ...
                                    send_msg(user_id, message, get_keyboard("numbers7"),
                                             state="service_selection_question")
                                    ...
                                    for event in longpoll.listen():
                                        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                            ...
                                            if msg == "1":
                                                ...
                                                send_msg(user_id, message, get_keyboard("back"),
                                                         state="service_selection_ans")
                                            elif msg == "2":
                                                ...
                                                message = "О каком типе организации Вам хочется узнать подробнее?"
                                                send_msg(user_id, message, get_keyboard("org"),
                                                         state="service_selection_org")
                                                break
                                            break
                                    ...
                                    send_msg(user_id, message, get_keyboard("numbers8"),
                                             state="service_selection_question")
                                ...
                                if msg == 'ввод инн/огрн организации':
                                    ...
                                    for event in longpoll.listen():
                                        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                            ...
                                            cursor = connection.cursor()
                                            cursor.execute(
                                                f"SELECT ur_name FROM comp WHERE inn={msg} or ogrn={msg}")
                                            res = cursor.fetchone()
                                            if res == 'None':
                                                send_msg(user_id,
                                    ...
                                    for event in longpoll.listen():
                                        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                                            ...
                                            print(msg)
                                            cursor.execute(
                                                f"SELECT ur_name FROM comp WHERE ur_name LIKE '%{msg}%'")
                                            res = cursor.fetchone()
                                            if res != "None":
                                                send_msg(user_id,
